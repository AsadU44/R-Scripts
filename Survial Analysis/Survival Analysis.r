...
cox2<-coxph(Surv(Time, Status) ~ Group+Sex+Race+Stage+
              Smoking.Habit+Metastasis.Status, data = data)
cox2

tbl_regression(cox2, exp = TRUE)

ggforest(cox2, data = data, fontsize = 1, refLabel = 'Reference'
         , main = 'Forest Plot of Cox-regression')
