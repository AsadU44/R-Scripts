...
Plot1<- ggplot(data, aes(x=Count, y=Term, color=Adjusted.P.value, 
          size=Count))+ geom_jitter()+scale_size_continuous(range=c(4,10)) + #theme_minimal()+ 
